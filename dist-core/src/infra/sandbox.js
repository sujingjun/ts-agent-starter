...
export function sandboxTestTool(workspace, image = 'node:22-bookworm-slim') {
    return {
        ...
        async execute(_input, context) {
            ...
            return await new Promise((resolve, reject) => {
                ...
                let out = '', err = '';
                child.stdout.on('data', (b) => { out = (out + b.toString()).slice(0, 10000); });
                child.stderr.on('data', (b) => { err = (err + b.toString()).slice(0, 10000); });
