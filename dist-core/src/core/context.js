...
export function estimateTokens(value) { return Math.ceil(Buffer.byteLength(JSON.stringify(value), 'utf8') / 3); }
...
export function buildContext(messages, tools, budget) {
    ...
    let kept = groups.length ? [groups.at(-1)] : [];
