...
<template>
  <main class="shell">
    <header class="masthead"><div><p class="eyebrow">TYPE SCRIPT · AGENT ENGINEERING</p><h1>把一次回答，变成可追溯的执行。</h1><p class="subtitle">任务、工具、证据与审批，在同一条运行记录中查看。</p></div><UBadge color="neutral" variant="subtle">原生核心对照 / 0.2</UBadge></header>
